...
--
--TABLA PARA REGISTRAR DOCENTES Y REVISAR REGISTRO
--
CREATE TABLE `deportepoli`.`docentes` ( `IdDoc` INT(20) NOT NULL ,
  `NDoc` VARCHAR(30) NOT NULL , 
   `ADoc` VARCHAR(30) NOT NULL , 
    `TeleDocente` VARCHAR(20) NOT NULL , 
     `celuDocente` VARCHAR(20) NOT NULL , 
      `DirecDocente` VARCHAR(20) NOT NULL ,  
      `Disciplina` VARCHAR(30) NOT NULL ,   
       PRIMARY KEY  (`IdDoc`)) ENGINE = InnoDB;

--
--Insertar datos en tabla DOCENTES
--

INSERT INTO `docentes` (`IdDoc`, `NDoc`, `ADoc`, `TeleDocente`, `celuDocente`, `DirecDocente`, `Disciplina`)
 VALUES ('123', 'Ana', 'Lopez', '2222', '11111', 'cll r', 'futbol'),
  ('345', 'Juan', 'Martinez', '33333', '22234', 'cll y', 'voleibol');
--
